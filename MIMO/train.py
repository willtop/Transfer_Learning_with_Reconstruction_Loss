...
def plot_training_curves():
    ...
    axes[1][0].semilogy(train_losses[:,0], 'g', linewidth=line_width, label="Regular Learning")
    axes[1][0].semilogy(train_losses[:,1], 'b', linewidth=line_width, label="Conventional Transfer")
    axes[1][0].semilogy(train_losses[:,2], 'r', linewidth=line_width, label="Transfer with Reconstruct")
    ...
    axes[1][1].semilogy(valid_losses[:,0], 'g', linewidth=line_width, label="Regular Learning")
    axes[1][1].semilogy(valid_losses[:,1], 'b', linewidth=line_width, label="Conventional Transfer")
    axes[1][1].semilogy(valid_losses[:,2], 'r', linewidth=line_width, label="Transfer with Reconstruct")
    # [optional] zoom in on the tailing behavior of validation curves on target task
    axes[1][1].set_ylim(bottom=0,top=80)
