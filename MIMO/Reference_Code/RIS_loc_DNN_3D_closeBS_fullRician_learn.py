...
plt.show()
sio.savemat('./loc/DNN_fixSNR_learn/data_DNN_loc_RIS_learn_closeBS_fullRician_3D_tau_'+ str(tau) +'_snr'+str(snr_const[0]) +'_rician_' + str(Rician_factor) +'.mat',dict(performance= performance,\
